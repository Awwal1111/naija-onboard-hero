...
const MainFeed = () => {
  ...
  // Show skeleton only when auth is loading OR feed is actively fetching for a logged-in user
  // CRITICAL: Never show skeleton if auth timed out or resolved without user
  if (authLoading) {
    return <FeedSkeleton />
  }
