...
import { User, Briefcase, FileText, GraduationCap, Heart, AlertCircle, Banknote, Gift, Newspaper } from "lucide-react";
...
export const MoreMenuDrawer = ({ open, onOpenChange }: MoreMenuDrawerProps) => {
  ...
  const menuItems = [
    ...
    { icon: Newspaper, label: "Job Feeds", path: "/external-jobs", color: "text-cyan-500" },
