...
const GlobalPresenceManager = lazy(() => import('@/components/GlobalPresenceManager').then(m => ({ default: m.default || (() => { const { GlobalPresenceManager } = m as any; return GlobalPresenceManager; })() })))
