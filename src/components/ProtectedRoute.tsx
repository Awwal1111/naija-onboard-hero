...
export const ProtectedRoute = ({ 
  ...
  // CRITICAL: Render children immediately while auth is loading
  // This prevents any intermediate spinner/skeleton from blocking the UI.
  // If auth resolves with no user, we redirect below.
  if (loading) {
    return <>{children}</>
  }
