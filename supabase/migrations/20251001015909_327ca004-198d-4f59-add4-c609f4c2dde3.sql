-- Fix SafePay accept function to properly deduct and hold funds
...
-- Fix SafePay release function to properly credit seller
...
BEGIN
  ...
  IF v_status = 'active' THEN
    ...
    INSERT INTO public.wallet_transactions (user_id, safepay_id, transaction_type, amount, status, description)
    VALUES (v_buyer_id, p_safepay_id, 'refund', v_amount, 'completed', 'SafePay refund - transaction cancelled');
  END IF;

  -- Update SafePay status to cancelled
  UPDATE public.safepay_transactions 
