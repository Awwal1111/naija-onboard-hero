...
-- Create simple admin role check function - can be configured by adding admin users
...
AS $$
  SELECT auth.uid() = '00000000-0000-0000-0000-000000000000'::uuid  -- Replace with actual admin user ID
$$;
